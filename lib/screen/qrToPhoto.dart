...
class _QRToPhotoScreenState extends State<QRToPhotoScreen> {
      ...
      return AlertDialog(
        ...
        content: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: <Widget>[
            IconButton(icon: Icon(Icons.center_focus_strong),onPressed: (){
  ...
  takePhoto()async{
    final img=await _imagePicker.getImage(source: ImageSource.camera,maxWidth: 200,maxHeight: 200);
    if(img!=null){
      tempres="tempres";
      setState(() {
  ...
  choosePhoto()async{
    final img=await _imagePicker.getImage(source: ImageSource.gallery,maxWidth: 200,maxHeight: 200);
    if(img!=null){
      tempres="tempres";
      setState(() {
        _image=File(img.path);
